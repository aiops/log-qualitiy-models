...
setup(
    name='ling_qulog_sm_rf', # !!! Autogenerated !!! Do not change the name
    version='1.0',
    ...
    packages=['ling_qulog_sm_rf'], # !!! Autogenerated !!! Do not change the name
    include_package_data=True,
    package_data={
        'ling_qulog_sm_rf': ['model'], # !!! Autogenerated !!! Do not change the name
    },
    install_requires=[
        "scikit-learn==0.24.2",
        "spacy==3.1.0",
