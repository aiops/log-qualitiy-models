...
setup(
    name='qulog_sm_svc', # !!! Autogenerated !!! Do not change the name
    version='1.0',
    ...
    packages=['qulog_sm_svc'], # !!! Autogenerated !!! Do not change the name
    include_package_data=True,
    package_data={
        'qulog_sm_svc': ['model'], # !!! Autogenerated !!! Do not change the name
    },
    install_requires=[
        "scikit-learn==0.24.2",
        "spacy==3.1.0",
